function [eta_prog, eta_evan] = calc_eta_bound_sum(pot_2D, x, time)
% [eta_prog, eta_evan] = calc_eta_bound_sum(pot_2D, x, time)
% @POTENTIAL_2D\CALC_ETA_BOUND_SUM evaluates the 2nd-order sum bound wave elevation at position x 
