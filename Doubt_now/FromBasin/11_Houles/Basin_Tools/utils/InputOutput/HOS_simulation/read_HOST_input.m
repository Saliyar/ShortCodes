function input = read_HOST_input(directory, filename)
% input = read_HOST_input(directory, filename)
% LIB/SIMULATION/READ_HOST_INPUT
% Reads the input data contained in the HOST input file 
% (with only one argument, file implicitly named 'input_WestSideStory.dat')
% or 
% in the header of a HOST data file  and stores into an input structure
% (in this case, the file name is required, it can be either '3d.dat',
% 'probes.dat'...
% The variables' names in the structure are the same as in the HOST
% program
% 
% Félicien 10/09/2009
%
