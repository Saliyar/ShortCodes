function MOCEAN_build_waves_all_and_oblique_test(series,direction)
...
[periods, amplis, Holambda, lambdaoH, correc, rnum, file_name, lambda, directions]= MOCEAN_define_waves_correction(series,direction);
%
...
for n=runs
    ...
    if abs(directions(n)<0.01)
        ...
        [wv_1st{n}, wv_2nd{n}, wv_free{n}] = eval_wave_and_corrections(T_repeat, 16, harmo{n}, wmk);
        ...
        % .dat file name
        ocean_write_all( wv_2nd{n} , path, file_name, m, fid, fid_sum)
        ...
        % .dat file name
        ocean_write_all(wv_1st{n}, path, file_name, m, fid, fid_sum)
        ...
        % .dat file name
        ocean_write_all(wv_free{n}, path, file_name, m, fid, fid_sum)
