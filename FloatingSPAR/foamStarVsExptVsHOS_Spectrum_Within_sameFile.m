%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function foamStarVsExptVsHOS_Spectrum_Within_sameFile(HOS_Filelocation,ExptIrr_Filelocation,foamStar_Filelocation)
...
%% Expt File 
 ...
 %% foamStar File 
foamStarfullfile=fullfile(foamStar_Filelocation,'/postProcessing/waveProbe/0/surfaceElevation1.dat')
fsdata=load(foamStarfullfile);
dt_foamStar=fsdata(:,1);
Eta_foamStar=fsdata(:,2:end);
...
for i=probe
    ...
    hold on 
    plot(dt_foamStar,Eta_foamStar(:,ProbeCFD),'LineWidth',3)
    xlim([0 70])
