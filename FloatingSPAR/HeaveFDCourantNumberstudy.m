function  HeaveFDCourantNumberstudy(Exptpath,SPAR_Postprocessing_foamStar,titl,ylbl,nStart,nEnd,lgd3,phaseshift,xlbl)
...
%% Loading Experimental Details 
   ...
   motion_Experiment(:,3)= motion_Experiment(:,3)- mean(motion_Experiment(2000:end,3)); %2000 because of average after 6s 
...
for j=nStart:nEnd   
   ...
   plot(dt_motion,Heave_Experiment,'Linestyle','--','LineWidth',3,'color','k')
    ...
    %legend ('FS Refinement 1','FS Refinement 2','FS Refinement 3','FS Refinment 4','Experiment','interpreter','latex','FontSize',32);
    %legend (lgd3{:},'interpreter','latex','FontSize',32,'Location','southwest');
    legend('foamStar-PPSD35SL4','Experiment','interpreter','latex','FontSize',32,'Location','northeast')
    grid on;
    grid minor;
    hold off
