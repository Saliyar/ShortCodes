function HeaveFD_ppcdStudy(Exptpath,SPAR_Postprocessing_foamStar,titl,ylbl,nStart,nEnd,lgd6,phaseshift)
...
for j=nStart:nEnd
   ...
   SPAR_Postprocessing=[SPAR_Postprocessing_foamStar,num2str(j)];
    ...
    legend (lgd6{:},'interpreter','latex','FontSize',32,'Location','southwest');
    grid on;
    hold off
