function  HeaveFD_mass_sensitivitystudy(Exptpath,SPAR_Postprocessing_foamStar,titl,ylbl,nStart,nEnd,lgd4,phaseshift)
...
for j=nStart:nEnd   
    ...
    legend (lgd4{:},'interpreter','latex','FontSize',32,'Location','southwest');
    grid on;
    hold off
