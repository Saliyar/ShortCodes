%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function  SPAR_OuterBoxandBottomBoxRefinment(Exptpath,SPAR_Postprocessing_foamStar,titl,ylbl,nStart,nEnd,lgd3,phaseshift,xlbl)
...
for j=nStart:nEnd   
   ...
   plot(dt_motion,Heave_Experiment,'Linestyle','--','LineWidth',3,'color','k')
    ...
    legend ('Bottom Box - Coarse','Bottom Box - Medium','Bottom Box - Fine','Experiment','interpreter','latex','FontSize',32);
