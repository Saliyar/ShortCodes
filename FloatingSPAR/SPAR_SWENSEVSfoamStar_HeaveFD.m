%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function  SPAR_SWENSEVSfoamStar_HeaveFD(Exptpath,SPAR_Postprocessing_foamStar,titl,ylbl,nStart,nEnd,lgd3,phaseshift)
...
for j=nStart:nEnd   
   ...
   plot(dt_motion,Heave_Experiment,'Linestyle','--','LineWidth',3,'color','k')
    ...
    legend ('MeshFineppcd35Level4 foamStar ','MeshFineppcd35Level4 SWENSE','Experiment','interpreter','latex','FontSize',32);
