%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function  SPAR_FreeSurfaceLevel(Exptpath,SPAR_Postprocessing_foamStar,titl,ylbl,nStart,nEnd,lgd3,phaseshift)
...
for j=nStart:nEnd   
   ...
   plot(dt_motion,Heave_Experiment,'Linestyle','--','LineWidth',3,'color','k')
    ...
    legend ('Free Surface Box- Medium','Free Surface Box- Fine','Experiment','interpreter','latex','FontSize',32);
