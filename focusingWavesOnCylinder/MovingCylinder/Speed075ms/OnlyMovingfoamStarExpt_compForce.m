function OnlyMovingfoamStarExpt_compForce(Exptforcepath,ExptIndices,foamStarmovgenfile,cps)
...
foamStarfullfile=fullfile(foamStarmovgenfile,'forces/0/forces1.dat')
