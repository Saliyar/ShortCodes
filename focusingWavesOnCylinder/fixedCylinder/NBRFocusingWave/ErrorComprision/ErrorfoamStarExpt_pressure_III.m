function ErrorfoamStarExpt_pressure_III(Exptpressurepath,ExptPressureIndices,foamStarfile,SWENSEfile,cps,PP_static,ccost)
...
dt_PP=data{50:end,1};
PP_foamStar=data{50:end,2:end};

SWENSEfullfile=fullfile(SWENSEfile,'/probes/0/p')
data1=readtable(SWENSEfullfile);

dt_PP_S=data1{50:end,1};
PP_SWENSE=data1{50:end,2:end};
...
for i=2:8
   ...
   Error=[max(IPP1_foamStarB) max(IPP1_SWENSEB)]
