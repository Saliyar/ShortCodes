function Ncases_ErrorfoamStarExpt_pressure_III(Exptpressurepath,ExptPressureIndices,BaseName_foamStar,BaseName_SWENSE,cps,PP_static,numfoamStar,nSWENSE,nstart,nend,ccost,lgd,mkrs)
...
% Interpolating SWENSE values  
  ...
  %% Plotting the interploated values 
...
%     set(gca,'ygrid','on','gridlinestyle','-')
   ...
   % legend(legendCell,...
    ...
    fname = '/home/saliyar/ownCloud3/Documents/owncloud-My sharing folder/Error_figures/PressureError/MaxError/';
    ...
    plot(ccost(i),mean(Q4(:,i)),'Marker',mkrs(Gtype),'MarkerSize',markersize,'linewidth',linewidth-1,'color',cOrder(i,:))  
     ...
     set(gca, 'XScale', 'log')
     set(gca,'xgrid','on','ygrid','on','gridlinestyle','-')    
     ylabalis =sprintf('Normalised Error');
     ylabel(ylabalis,'fontsize',fontsize,'interpreter','latex')
